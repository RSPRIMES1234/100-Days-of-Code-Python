...
class CafeForm(FlaskForm):
    ...
    coffee_rating = SelectField('Coffee Rating', validators=[DataRequired()],choices=["✘"]+["☕️"*x for x in range(1,6)])
    wifi_rating = SelectField('Wifi Strength Rating', validators=[DataRequired()],choices=["✘"]+["💪"*x for x in range(1,6)])
    power_rating = SelectField('Power socket availability', validators=[DataRequired()],choices=["✘"]+["🔌"*x for x in range(1,6)])
